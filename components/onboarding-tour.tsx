      ...
      {open ? (
        <div className="fixed inset-0 z-[85]">
          ...
          <motion.div
            ...
            className="absolute inset-x-4 top-1/2 mx-auto max-w-md -translate-y-1/2 rounded-3xl border border-border bg-card p-6 shadow-[var(--ombra-dialogo)] sm:inset-x-auto sm:left-1/2 sm:w-full sm:-translate-x-1/2"
          >
