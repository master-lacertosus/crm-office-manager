...
export function AzioniMultiple() {
  ...
  return (
    <div
      ...
      className="fixed inset-x-0 bottom-4 z-70 mx-auto flex w-fit max-w-[calc(100vw-2rem)] flex-wrap items-center gap-2 rounded-2xl border border-border bg-velo/95 px-3 py-2 shadow-[var(--ombra-pannello)] backdrop-blur-md"
    >
