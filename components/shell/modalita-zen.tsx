...
export function InterruttoreZen() {
  ...
  return (
    <button
      ...
      className={cn(
        "fixed bottom-0 left-1/2 z-90 flex h-10 w-20 translate-x-[calc(-50%+5.5rem)] items-end justify-center rounded-t-full pb-2.5 shadow-[var(--ombra-da-sotto)] transition-[height,padding] duration-200 outline-none hover:h-12 hover:pb-3.5 focus-visible:ring-2 focus-visible:ring-ring",
        zen
