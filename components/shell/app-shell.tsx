...
export function AppShell({ children }: { children: React.ReactNode }) {
  ...
  return (
    ...
    >
      ...
      <div className="flex min-h-dvh w-full lg:m-4 lg:min-h-[calc(100dvh-2rem)] lg:w-[calc(100%-2rem)] lg:overflow-clip lg:rounded-[28px] lg:border lg:border-velo/70 lg:bg-velo/50 lg:shadow-[0_1px_2px_var(--ombra-card),var(--ombra-dialogo),inset_0_1px_0_var(--vetro-luce)]">
        <Sidebar />
