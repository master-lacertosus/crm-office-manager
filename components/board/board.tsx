...
function Column({
  ...
  if (collapsed) {
    return (
      <section
        ...
        className={cn(
          "flex w-11 shrink-0 snap-start flex-col rounded-2xl p-1 shadow-[inset_0_1px_0_var(--vetro-luce)] transition-[background,box-shadow]",
          meta.kind === "alert" ? "bg-danger-soft/80" : "bg-secondary/70",
          isTarget &&
            "bg-brand-50 ring-1 ring-brand-300/70 shadow-[inset_0_1px_0_var(--vetro-luce),0_10px_34px_-10px_color-mix(in_oklch,var(--brand-500),transparent_60%)]",
        )}
      >
        <button
          type="button"
  ...
  return (
    <section
      ...
      aria-label={meta.label}
      className={cn(
        "flex w-[290px] shrink-0 snap-start flex-col rounded-2xl p-2 shadow-[inset_0_1px_0_var(--vetro-luce)] transition-[background,box-shadow]",
        meta.kind === "alert" ? "bg-danger-soft/80" : "bg-secondary/70",
        isTarget &&
          "bg-brand-50 ring-1 ring-brand-300/70 shadow-[inset_0_1px_0_var(--vetro-luce),0_10px_34px_-10px_color-mix(in_oklch,var(--brand-500),transparent_60%)]",
