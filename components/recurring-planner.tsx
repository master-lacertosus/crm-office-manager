        ...
        {open ? (
          <div className="fixed inset-0 z-[75]">
            ...
            <motion.div
              ...
              className="absolute inset-x-4 top-1/2 mx-auto max-h-[85dvh] max-w-2xl -translate-y-1/2 overflow-y-auto rounded-3xl border border-border bg-card p-6 shadow-[var(--ombra-dialogo)] sm:inset-x-auto sm:left-1/2 sm:w-full sm:-translate-x-1/2"
            >
                ...
                {templates.map((tpl) => {
                  ...
                  if (active) {
                    ...
                    return (
                      <div
                        key={tpl.id}
                        className="flex items-center gap-3 rounded-xl border border-border-soft bg-canvas px-3 py-2.5"
                      >
                        <CheckCircle2
