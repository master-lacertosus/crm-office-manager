...
function ProgressRing({
  ...
  return (
    <div className="relative mx-auto size-[140px] shrink-0 rounded-full bg-[linear-gradient(180deg,#ffffff_0%,#f7f9fc_100%)] shadow-[var(--ombra-sollevata),inset_0_1px_0_var(--vetro-luce-piena),inset_0_0_0_1px_var(--vetro-luce)] sm:mx-0">
              ...
              return (
                <li key={person.id}>
                  ...
                  >
                    ...
                    <span className="flex h-[7px] flex-1 gap-[2px] overflow-hidden rounded-full bg-secondary">
                      {statuses.map((meta) => {
